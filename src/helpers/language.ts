export const language = {
	en: {
		...
		status: `Status`,
		stakeNav: `Stake`,
		nasaPageTitle: `Node Availability Staking Alpha`,
		...
		operatorLastEpochRewardDistributed: `Last epoch reward distributed (per 100 score)`,
		operatorStakeAmountLabel: `Amount to stake / unstake`,
		operatorStakePlaceholder: `0.00`,
		operatorStakeReferenceLabel: `Reference`,
		operatorStakeReferenceInfo: `Http reference that you want to name route as.`,
		operatorStakeReferencePlaceholder: `your-node-reference`,
		operatorStakePrefixLabel: `Prefix`,
		operatorStakePrefixInfo: `URL of your AO node`,
		operatorStakePrefixPlaceholder: `https://your-node.example.com`,
		operatorStakePeerNodesTitle: `Add your array of peer nodes`,
		operatorStakePeerNodePlaceholder: `https://peer.example.com`,
		operatorStakeAddPeer: `Add More +`,
		...
		operatorStakeMinimumEntry: `Minimum entry is 25 AO.`,
		operatorStakeBelowMinimum: `Amount must be at least 25 AO to stake.`,
		operatorStakePeerRequired: `Add at least one peer node before staking.`,
		operatorStakePeerInvalid: `Each peer node URL must start with "https://".`,
		operatorStakeReferenceRequired: `Reference is required.`,
		operatorStakeReferenceInvalid: `Reference must be 3-64 characters and use letters, numbers, "-", "_" or ".".`,
		operatorStakePrefixRequired: `Prefix is required.`,
		operatorStakePrefixInvalid: `Prefix must start with "https://".`,
		operatorStakeContextInvalid: `Stake validation failed. Please try again.`,
