const AoLogo = ({ color }) => {
	return (
		<svg width="24" height="11.97" viewBox="0 0 429 214" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M0 214H71.3763L85.9429 174.61L53.1681 107.5L0 214Z" fill={color} />
			<path d="M189.366 160.75L109.978 1L85.9429 55.7089L160.961 214H215L189.366 160.75Z" fill={color} />
			<path
				fill-rule="evenodd"
				clip-rule="evenodd"
